...
Training with all of LiveCell data using Cascade Mask RCNN: 
...
Transfer Learning using Sartorius Dataset: 
...
Inference on all Semi-Supervised data to create .json pseudo_labels file; 
...
Training with pseudo labels and train dataset
